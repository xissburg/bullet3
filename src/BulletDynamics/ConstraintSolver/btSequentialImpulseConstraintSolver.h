...
public:
	...
	btSolverConstraint& getSolverContactConstraintAtIndex(int i) 
	{ 
		return m_tmpSolverContactConstraintPool[i]; 
	}

	btSolverBody& getSolverBodyAtIndex(int i) 
	{ 
		return m_tmpSolverBodyPool[i]; 
	}
